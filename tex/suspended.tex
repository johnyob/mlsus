...
word we're introducing in the title (we should minimize new jargin in the title)}
...
\Xalistair{Could also be G-directional, for Generalization.}
...
\Xdidier{Yes, I found it as well, but lost my text in the merge: I was
proposing the following as a fix}

I was suggestingf to replace the premises of rule \Rule {Proj-I} by
\begin{mathpar}
\G \th E[\exfield e n j] : \t
