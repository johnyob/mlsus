...
%
  ...
  \smashcolorbox{welltyped}{\strut green} and ill-typednes (warnings and errors)
...
While both stategies for directional type inference have some virtues, and
...
This somtimes makes them counter intuitive.
For example,
