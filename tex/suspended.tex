...
resolution strategy instead of failing when the type is ambiguous,
  ...
  check all examples, you should use the options \texttt{-principal -w +41},
  which enforce principality checks and enables
  ...
  \smashcolorbox{red!20}{red}.}\saveFN\principalFN
\relax
...
flag\useFN\principalFN to require the more expensive computation when
desired.
...
%%
  Unsurprisingly, their actual implementations described in
...
then fails to type \code{r.y}, as this default choice is f ixed---even
though
...
Typing constraints in~\cite* {Pottier-Remy/emlti} allow
let-constaints to be copied
