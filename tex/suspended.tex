...
\TODO{Add a single figure for syntax + also add all definition blocks}
...
\begin{judgboxmathpar}
  ...
  \rewrite[S-Let-Exists-InstLeft]
    {\cletr \x \tv \tvs {\cexistsi \inst \xp \ca} \cb}
  ...
  \rewrite[S-Let-Exists-InstRight]
  ...
  \rewrite[S-Compress]
    ...
    {\cletr \x \tv {\tvs, \tvb} {\ca\where{\tvb \is \tvc} \cand \cunif \tvc {\ueq\where{\tvb \is \tvc}}} {\cb\where{\x.\tvb \is \tvc}}}
  ...
  \rewrite[S-All-Exists-Inst]
    {\cfor \tvs {\cexists \tvbs {\cexistsi \inst \x \c}}}
    {\cexistsi \inst \x {\cfor \tvs {\cexists \tvbs \c}}}
