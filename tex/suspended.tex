...
\Xdidier {We never defined the syntax of types? This, we need to do, at
least somewhere.}
...
well-formedness}
\Xdidier {We still need to say something, just that it is obvious...}
\Xalistair {This is fixed, see \cref{fig:ty-wf}}
