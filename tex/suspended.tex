...
\begin{proof}
  ...
  constraint solving, it thus suffices to prove that that rewriting
  ...
  can thus only occur finitely many time in non-discharging sequences,
  and it suffices to prove that all rewriting sequences that are
  non-discharging and are not \Rule{S-Let-AppR} are finite.
