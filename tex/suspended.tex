...
has a view on the whole program and may learn from the body of the let-binding
...
\Xalistair {I personally find $\shape \t \Defined$ clearer, it is obvious
to me that $\decomp \t$ is defined when $\shape \t$ is defined. But I
don't have a strong opinion on this.}\Xdidier {(1) We would just avoid another
definition (2) I don't like to work with partial definitions: more difficult
to remember the invariants.}
...
is a unique possible shape.  This rule is typically used in combination with
...
and let-generalisation. We illustrate this by considering
%
...
\begin{definition}
  ...
  to $\sh$.
%
  In other words:\Xdidier {Repeating the formular from \cref
