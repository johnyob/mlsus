...
\Xalistair{We should make semantic environments less 'ordered' and total --
\ie two total mappings from type variables to ground types and term variables
to sets of ground types.}
