...
\end{program}
All are arguably unambiguous; \OCaml accepts none of them\footnote{It accepts \ocaml{e_6} with a warning, and fails if we reverse the order of the type declarations.}, \OML accepts the first three.
