...
\begin{mathparfig}[htpb!]
  ...
  \rewrite[S-Compress]
    ...
    {\cletr \x \tv {\tvs, \tvb} {\ca\where{\tvb \is \tvc} \cand \cunif \tvc {\ueq\where{\tvc \is \tvc}}} {\cb\where{\x.\tvb \is \tvc}}}
...
\tvc}$\footnote{Removal of `dead' variables is handled by \Rule{S-Gc} in
