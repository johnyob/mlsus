...
typically for dynamic overloading. We had to introduce the more complex partial
generalization to express features that require a unique resolution of the
constraint, typically for static overloading.
