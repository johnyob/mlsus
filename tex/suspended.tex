...
the constraints $f (\semenv \sh)$ and $\semenv (f (\sh))$ are equivalent.
  \Xalistair{This last statement makes no sense -- $\semenv$ doesn't operate on constraints
  or shapes (according the the above redefinition of shapes, since they're closed).}
\hparenclose
