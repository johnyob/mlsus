...
\begin{definition}[Unicity]
  We define the unicity condition $\Cshape \C t \sh$, which states that $\t$
...
annotating shape is fully determined from the context, and from
the type of either the context hole or the expression.
%
