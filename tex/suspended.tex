...
never inspired by Leijen! Citing Leijen is fine, but not in this way...}
\Xalistair{This is Leijen's overloading though right? I guess the citation
was a way to get what we intended anyway without need to review the work}
in
...
let-generalization.
%
As future work, we aim to extend our constraint language to typecheck an implicit parameter
calculus, similar to \COCHIS
...
\Xalistair{Does the above now work?}
...
We can think of this result as controlling the amount of
non-syntax-directedness in our rules: we fundamentally need
a non-syntax-directed (contextual) rule, but it suffices to have it
only at the outside, and inside it contains a more standard derivation
