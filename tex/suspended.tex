...
\TODO{Introduce tuple projections here and tuple patterns}
% Tuple projections from SML

% The typing of SML uses structural records for tuples, but had the
% adhoc requirement that the tail of the row must be unified to a concrete
% row -- it cannot be polymorphic


% Thus tuple projections can be seen as static overloading
% They differ from record / constructor overloading in that the overloadings
% cannot finitely be enumerated
