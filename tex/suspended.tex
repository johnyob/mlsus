...
Finally, Rule \Rule{S-BackProp} expresses \emph{backpropagation}, the mechanism that allows type information from use sites to refine matched variables inside generalised abstractions.
