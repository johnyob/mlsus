...
than fail. Using default shapes rather that defauilt types ensures that at
least the default behavior could have been obtained by adding an extra
shape annotation in the code.
