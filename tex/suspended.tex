...
\Xdidier {Indeed, backpropagation might be a problem.
I think Alistair had a clue.}

\Xalistair{I tried with one called SOSML (online) and found
the following is ill-typed}
\begin{verbatim}
fun proj2 (x) = #2 x
val x = proj2 (1, 2);
\end{verbatim}
\Xalistair{Adding an annotation to the parameter works though}
