...
\Xdidier[inspired by\citet*{Leijen-Ye/prefix@pldi2025}]{not at all! it was
never inspired by Leijen! Citing Leijen is fine, but not in this way...}  in
...
%% , where $\M$ is a disambiguating namespace.
%
...
calculus, inspired\Xdidier{Could we say similar instead of inspired?} by \COCHIS
\citep*{journals/jfp/SchrijversOWM19}, with implicit parameter abstraction
$\eifun \t \e$ and resolution $\eimplicit \t$.

\Xdidier{It is unclear to me what
you have in mind... I don't understand $\eifun \t \e$. Do you mean $\eifun
\tv \e?$. So it should even worse for the reader. We should say how it would
differ from \COCHIS, which
only does the easy part---not polymorphism inference}
...
We formalize this with the judgment $\G \th \bar \el \uni \t$, which
either:
\begin{enumerate*}
...
and constructions, and corresponds to the judgment $\G \th \bar \el \uni \t$
...
% Other cases
The remaining (grayed) cases \TODO{Make the cases gray} correspond to internal
...
%
We begin by proving some auxiliary lemmas regarding inversion and
...
\begin{proof}
  ...
  \Xalistair{Agreed. This is something I realized after coming up with
