...
them, such as flexible structural\Xdidier{I like structural (suggested by
Alistair), but usually people call them flexible records, so I kept both, is
this ok?} records, higher-kinded types, or dimensional types fits nicely
...
exampples that would brak completeness, but also many others.  Fragile
extensions can actually be viewed as an elaboration into the slightly weaker
language that makes annotations mandatory, but itself fits nicely into the
...
\Xalistair{We could mention stratified type inference here, 
which makes this idea more explicit}\Xdidier{@Alister: Is this enough, or
you meant to explained what it does?}
%
...
the non-principal directional behaviour (I know I do)}\Xdidier {Not even so,
because we cancel the default strategy, but yes we should say something}
