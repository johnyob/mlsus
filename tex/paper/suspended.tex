...
\begin{version}[Inlined Conflict]{}
\Xdidier {This has been cut off but conflicting. 
 Double check and remove it}
...
need state how difficult this was :/} Formulating a suitable constraint
...
simple:
\begin{align*}
  \cinfer {\epoly e {\tfor {\overline{\cvb}} \t}} \cva &= \left(\cfor
  {\overline{\cvb}} \cinfer e \t \right) \cand \cva = [\tfor
  {\overline{\cvb}} \t] 
\end{align*}
