...
\end{align*}
\Xdidier {The polytype shape, should is not be any $\exi \tvs \ts$. $\ts$
but only those of the form $\all \tvbs \t$ such that every node of $\t$
leads to a polymorphic variable in $\tvbs$ or is a monormorphic variable in
$\tvs$}
